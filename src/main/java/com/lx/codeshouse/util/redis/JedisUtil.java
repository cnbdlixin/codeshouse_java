package com.lx.codeshouse.util.redis;

import com.lx.codeshouse.util.Configuration;
...
public class JedisUtil {
    ...
    static {
        ...
        JEDIS_PASSWORD=conf.getString("jedis.password","tttt");
...
//        config.setNumTestsPerEvictionRun(-1);
        jedisPool=new JedisPool(config,JEDIS_IP,JEDIS_PORT,600,JEDIS_PASSWORD);
    }
    /**
     * 获取数据
     * @param key
