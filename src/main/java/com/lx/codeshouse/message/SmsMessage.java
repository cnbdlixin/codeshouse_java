...
public class SmsMessage {
    ...
    //短信模板ID
    private static final String TEMPLATEID="3051586";
    //手机号
    private static final String MOBILE="18510512189";
    //验证码长度，范围4～10，默认为4
    ...
    public static void main(String[] args) throws Exception {
        ...
        nvps.add(new BasicNameValuePair("mobiles", "['18510512189']"));
        nvps.add(new BasicNameValuePair("codeLen", CODELEN));
        nvps.add(new BasicNameValuePair("params", "['110']"));
